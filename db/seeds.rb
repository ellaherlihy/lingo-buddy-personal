...
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "English", location: "Evering Road, Hackney, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://i.pinimg.com/originals/97/ed/6b/97ed6b370803649addbf66144c18c194.png")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "English", location: "Mare Street, Hackney, London", email: Faker::Internet.email, rate: 8, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/portrait-of-smiling-mixed-race-woman-looking-at-camera-picture-id1319763830?b=1&k=20&m=1319763830&s=170667a&w=0&h=wE44n9yP1nrefeqv5DCl5mE3ouU01FNNHeZPR0yDCWA=")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "English", location: "Well Street, Hackney, London", email: Faker::Internet.email, rate: 12, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1573607217032-18299406d100?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8eW91bmclMjB3b21hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "English", location: "Margate Road, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://image1.masterfile.com/getImage/NjAwLTAwOTQ4NjcxZW4uMDAwMDAwMDA=AL2-ZR/600-00948671en_Masterfile.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Spanish", location: "Acacia Avenue, Wembley, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Spanish", location: "Alliance Close, Wembley, London", email: Faker::Internet.email, rate: 8, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1621903570450-b6750dce9350?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Spanish", location: "Bassingham Road, Wembley, London", email: Faker::Internet.email, rate: 12, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1520998116484-6eeb2f72b5b9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Spanish", location: "Beatrice Avenue, Wembley, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/attractive-senior-chinese-woman-smiling-picture-id1156954211?b=1&k=20&m=1156954211&s=170667a&w=0&h=4ajJasG9nC5JwjZv2NCVjNYL2cvztqtuhI_CRr5_3f8=")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "French", location: "Farm Lane, Fulham, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://t4.ftcdn.net/jpg/05/05/66/21/360_F_505662123_EKv3roI5MF7TLYUV1Gi6B1lzN9H4cbXD.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "French", location: "The Boltons, Kensington and Chelsea, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1568315081475-d8bbace35dd2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "French", location: "Goswell Road, Islington, London", email: Faker::Internet.email, rate: 8, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "French", location: "Arlington Road, Camden, London", email: Faker::Internet.email, rate: 12, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media-s3-us-east-1.ceros.com/forbes/images/2021/12/06/362f5f8159d82d577afb68ea5141cd35/artboard-2-copy-6-4.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Italian", location: "Bowland Road, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://t4.ftcdn.net/jpg/02/18/71/87/360_F_218718766_Pc3cFwBDSUqZtWUuBv2utZazq1joM5Eb.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Italian", location: "Chalk Farm Road, Camden, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Italian", location: "Bardsley Lane, Greenwich, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://t3.ftcdn.net/jpg/02/16/07/68/360_F_216076852_8Hn4FjfX0Pwr13rx00CMqyhwDGTupYFn.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Italian", location: "Baylis Road, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://i.pinimg.com/474x/fd/73/42/fd73421809d30fbadc0b21f01f229fa3--african-american-women-african-americans.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Russian", location: "Earlsfield Road, Wandsworth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://www.talentedladiesclub.com/site/wp-content/uploads/Michelle-Chandler.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Russian", location: "Sandgate Lane, Wandsworth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://funent.com/uploads/images/Blog/omar-yehia-1178252-unsplash.jpg")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Russian", location: "Heathfield Gardens,  Wandsworth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://www.aljazeera.com/wp-content/uploads/2013/09/2013925204345701525_8.jpeg?resize=1000%2C630")
User.create(bio: Faker::Lorem.paragraph(sentence_count: 15), languages: "Russian", location: "Edgeley Lane, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1530785602389-07594beb8b73?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aGFwcHklMjBhZnJpY2FuJTIwd29tYW58ZW58MHx8MHx8&w=1000&q=80")
...
User.create(bio: bio, languages: "German", location: "Winfrith Road, Wandsworth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "http://d279m997dpfwgl.cloudfront.net/wp/2020/07/Emmanuel-1000x776.jpg")
User.create(bio: bio, languages: "Hindi", location: "North End Road, Fulham, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/mature-african-man-portrait-picture-id180816724?k=20&m=180816724&s=612x612&w=0&h=GzhYNa9LcuyTBVtejayD5mniWgC7iAaIzn1iXG79KSI=")
User.create(bio: bio, languages: "Hindi", location: "Knivet Road, Fulham, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/portrait-of-a-taiwanese-man-picture-id1149504274?k=20&m=1149504274&s=612x612&w=0&h=3yLf9OAkYZ0hB_ezday1W-xpn_o_yjMCo7hX8rBwf4o=")
User.create(bio: bio, languages: "Hindi", location: "Horsford Road, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.pond5.com/hispanic-man-city-smile-happy-088159156_prevstill.jpeg")
User.create(bio: bio, languages: "Hindi", location: "Trent Road, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://photos.spareroom.com/images/flatshare/listings/large/20/01/200103922.jpg")
...
150.times do
  Review.create!(name: Faker::Name.name, content: Faker::Lorem.paragraph(sentence_count: 5), rating: 4, user_id: User.all.sample.id)
end

5.times do
  Review.create!(name: Faker::Name.name, content: Faker::Lorem.paragraph(sentence_count: 5), rating: rand(3..5), user_id: User.first.id)
end
