...
150.times do
  Review.create!(name: Faker::Name.name, content: "hello testing testing", rating: 4, user_id: User.all.sample.id)
end

5.times do
  Review.create!(name: Faker::Name.name, content: "hello testing testing", rating: rand(3..5), user_id: User.first.id)
end
